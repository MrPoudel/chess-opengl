HEADERS		= 	callbacks.hpp init.hpp menus.hpp GraphicModelChess.hpp globals.hpp \ 
...
SOURCES		=	project60337.cpp globals.cpp callbacks.cpp GraphicModelChess.cpp init.cpp menus.cpp models.cpp \
...
INCLUDEPATH     = 
LIBS            += -lGLEW -lglut -lGL -lX11  -lm -lGLU
TARGET			= chess
CONFIG 			-= qt warn_on
